...
from model.cnn import CNN #QUESTION: why is from model.cnn
...
def main():
    ...
    # Model
    model = CNN() #CNN class degined in cnn.py
    ...
    # Evaluate the randomly initialized model (before any training)
    _evaluate_epoch(axes, tr_loader, va_loader, model, criterion, start_epoch,
        stats)

    # Loop over the entire dataset multiple times, number of times determined by config
