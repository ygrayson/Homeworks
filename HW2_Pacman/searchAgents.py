...
class MoveAgent(Agent):
    "An agent that moves to wherever it can move to."
...
class SearchAgent(Agent):
    ...
    def __init__(self, fn='depthFirstSearch', prob='PositionSearchProblem', heuristic='nullHeuristic'):
        ...
        if 'heuristic' not in func.__code__.co_varnames:
            print('[SearchAgent] using function ' + fn)  # print the uninformed search method (no heuristic)
    ...
    def registerInitialState(self, state):
        ...
        self.actions  = self.searchFunction(problem) # Find a path, this line calls the function
